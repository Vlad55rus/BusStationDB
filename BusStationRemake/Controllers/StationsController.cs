...
namespace BusStationRemake.Controllers
{
    public class StationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,km_ot_omska,station_name")] Station station)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,km_ot_omska,station_name")] Station station)
        {
            if (ModelState.IsValid)
            {
